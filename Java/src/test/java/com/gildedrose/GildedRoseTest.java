...
public class GildedRoseTest {
	...
	public void should_quality_increases_when_aged_brie_gets_older() {
		Item[] items = new Item[] { new AgedBrieItem("Aged Brie", 2, 49), new AgedBrieItem("Aged Brie", -1, 10) };
	...
	public void should_quality_increases_when_backstage_passes_gets_older() {
		Item[] items = new Item[] { new BackstagePassesItem("Backstage passes to a TAFKAL80ETC concert", 15, 20) };
		GildedRose app = updateQuality(items);
	...
	public void should_quality_increases_by_2_when_there_are_10_days_or_less_to_sell_backstage_passes() {
		Item[] items = new Item[] { new BackstagePassesItem("Backstage passes to a TAFKAL80ETC concert", 10, 20),
				new BackstagePassesItem("Backstage passes to a TAFKAL80ETC concert", 10, 50) };
		GildedRose app = updateQuality(items);
	...
	public void should_quality_increases_by_3_when_there_are_5_days_or_less_to_sell_backstage_passes() {
		Item[] items = new Item[] { new BackstagePassesItem("Backstage passes to a TAFKAL80ETC concert", 5, 20),
				new BackstagePassesItem("Backstage passes to a TAFKAL80ETC concert", 1, 10) };
		GildedRose app = updateQuality(items);
	...
	public void should_not_quality_decreases_when_item_is_sulfuras() {
		Item[] items = new Item[] { new SulfurasItem("Sulfuras, Hand of Ragnaros", 0, 80),
				new SulfurasItem("Sulfuras, Hand of Ragnaros", -1, 10) };
		GildedRose app = updateQuality(items);
	...
	public void should_item_never_be_sold_when_item_is_sulfuras() {
		Item[] items = new Item[] { new SulfurasItem("Sulfuras, Hand of Ragnaros", 2, 80) };
		GildedRose app = updateQuality(items);
	...
	public void should_quality_decreases_when_dexterity_vest_gets_older() {
		Item[] items = new Item[] { new CommonItem("5 Dexterity Vest", 15, 20) };
		GildedRose app = updateQuality(items);
	...
	public void should_quality_decreases_twice_as_fast_when_dexterity_vest_sell_by_date_has_passed() {
		Item[] items = new Item[] { new CommonItem("5 Dexterity Vest", 0, 5) };
		GildedRose app = updateQuality(items);
	...
	public void should_not_quality_decreases_when_dexterity_vest_sell_in_is_less_than__0() {
		Item[] items = new Item[] { new CommonItem("5 Dexterity Vest", -1, -7) };
		GildedRose app = updateQuality(items);
	...
	public void should_quality_decreases_twice_as_fast_when_elixir_of_the_mongoose_sell_by_date_has_passed() {
		Item[] items = new Item[] { new CommonItem("Elixir of the Mongoose", 0, 7) };
		GildedRose app = updateQuality(items);
	...
	public void should_not_quality_decreases_when_elixir_of_the_mongoose_sell_in_is_less_than__0() {
		Item[] items = new Item[] { new CommonItem("Elixir of the Mongoose", -1, -7) };
		GildedRose app = updateQuality(items);
	...
	public void should_not_quality_be_negative() {
		Item[] items = new Item[] { new CommonItem("5 Dexterity Vest", 2, 0) };
		GildedRose app = updateQuality(items);
		assertThat(app.items[0].getQuality()).isEqualTo(0);
	}
	...
	public void should_not_quality_exceeds_50() {
		Item[] items = new Item[] { new AgedBrieItem("Aged Brie", 2, 50),
				new BackstagePassesItem("Backstage passes to a TAFKAL80ETC concert", 10, 49),
				new AgedBrieItem("Aged Brie", -1, 50),
